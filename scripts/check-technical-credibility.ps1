...
Require-Text "README" $readme 'Qorx Ayie Starter' "must explain the 5k full-feature starter"
...
Require-Text "docs index" $index 'AYIE_STARTER\.md' "must link the Ayie Starter page"
...
Require-Text "community" $community 'Qorx Ayie' "must name Qorx Ayie"
Require-Text "community" $community '5,000 included Ayie/Cloud requests' "must state the Starter allowance"
Require-Text "commands" $commands 'Qorx Ayie Commands' "must document Qorx Ayie command routing"
Require-Text "commands" $commands '(?m)^\s*daemon\s*$' "must list daemon as a Qorx Ayie command"
Require-Text "package channels" $packageChannels 'PyPI' "must document package channels"
Require-Text "package channels" $packageChannels '5,000 included Ayie/Cloud requests' "must keep Starter allowance visible in package docs"
...
Require-Text "TestSprite workflow" $testspriteWorkflow 'Qorx Ayie Starter' "must check Starter docs"
Require-Text "TestSprite workflow" $testspriteWorkflow '5,000 included Ayie/Cloud requests' "must check the Starter allowance"
