...
Require-Text "README" $readme 'Qorx Void Starter' "must explain the 5k full-feature starter"
...
Require-Text "docs index" $index 'AYIE_STARTER\.md' "must link the Void Starter page"
...
Require-Text "community" $community 'Qorx Void' "must name Qorx Void"
Require-Text "community" $community '5,000 included Void/Cloud requests' "must state the Starter allowance"
Require-Text "commands" $commands 'Qorx Void Commands' "must document Qorx Void command routing"
Require-Text "commands" $commands '(?m)^\s*daemon\s*$' "must list daemon as a Qorx Void command"
Require-Text "package channels" $packageChannels 'PyPI' "must document package channels"
Require-Text "package channels" $packageChannels '5,000 included Void/Cloud requests' "must keep Starter allowance visible in package docs"
...
Require-Text "TestSprite workflow" $testspriteWorkflow 'Qorx Void Starter' "must check Starter docs"
Require-Text "TestSprite workflow" $testspriteWorkflow '5,000 included Void/Cloud requests' "must check the Starter allowance"
...
Require-Text "TestSprite results" $testspriteResults 'TC001 Community homepage shows Qorx 0\.1-ylem' "must include the current CE homepage test"
...
$tc001 = Join-Path $RepoRoot "testsprite_tests\TC001_Community_homepage_shows_Qorx_0.1-ylem.py"
