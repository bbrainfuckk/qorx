...
$rustBrief = Read-RepoText "docs\QORX_1_0_6_RUST.md"
...
Require-Text "README" $readme 'agnostic programming language' "must identify the Qorx language"
Require-Text "README" $readme 'Technical credibility' "must link the technical credibility page"
Require-Text "docs index" $index 'agnostic programming language' "must identify the Qorx language"
...
Require-Text "Rust brief" $rustBrief 'provider-agnostic programming language' "must identify the Qorx language"
...
Require-Text "TestSprite workflow" $testspriteWorkflow '"version":"1\.0\.6"' "must smoke-test the current release version"
Require-Text "release workflow" $releaseWorkflow 'default:\s*"v1\.0\.6"' "must default to current release tag"
Require-Text "publish workflow" $publishWorkflow 'default:\s*"v1\.0\.6"' "must default to current release tag"
...
$tc001 = Join-Path $RepoRoot "testsprite_tests\TC001_Release_homepage_shows_Qorx_1.0.6.py"
