...
For the hosted Qorx Cloud or Qorx Void onboarding site, keep a separate
TestSprite suite against a public staging URL. That suite should cover Qorx Void
Starter account activation, the 5,000 included Void/Cloud request counter, and
...
tray, account activation, and request-counter checks belong to the Qorx Void
product flow suite.
